...
Vendored into modem73 from aicodix/modem
*/
...
#ifndef SC_THRESH_ON
#define SC_THRESH_ON 0.05
#endif
#ifndef SC_THRESH_OFF
#define SC_THRESH_OFF 0.04
#endif
#ifndef SC_PEAK_RATIO
#define SC_PEAK_RATIO 4.0
#endif
...
public:
	...
	SchmidlCox(const cmplx *sequence) : threshold(value(SC_THRESH_OFF * match_len), value(SC_THRESH_ON * match_len)) {
		fwd(kern, sequence);
	...
	bool operator()(const cmplx *samples) {
		...
		if (peak <= next * value(SC_PEAK_RATIO))
			return false;
